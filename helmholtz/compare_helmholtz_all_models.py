...
BIN_SIZE = 100
RESULT_DIRS = [
    ('PINN-ATTN', f'results_helmholtz_a1_{A1}_a2_{A2}_pinn_attention'),
    ('PCGRAD-ATTN', f'results_helmholtz_a1_{A1}_a2_{A2}_pcgrad_attention'),
    ('PINN-MLP', f'results_helmholtz_a1_{A1}_a2_{A2}_pinn_mlp'),
    ('PCGRAD-MLP', f'results_helmholtz_a1_{A1}_a2_{A2}_pcgrad_mlp'),
]
