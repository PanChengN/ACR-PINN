...
BIN_SIZE = 100
RESULT_DIRS = [
    ('PINN-ATTN', 'results_klein_gordon_pinn_attention'),
    ('PCGRAD-ATTN', 'results_klein_gordon_pcgrad_attention'),
    ('PINN-MLP', 'results_klein_gordon_pinn_mlp'),
    ('PCGRAD-MLP', 'results_klein_gordon_pcgrad_mlp'),
]
